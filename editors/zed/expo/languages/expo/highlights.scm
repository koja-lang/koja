; ============================================================================
; Syntax highlighting for Expo
; ----------------------------------------------------------------------------
; Capture names map to Zed theme tokens. Order matters: later captures
; override earlier ones, so generic captures (e.g. `@variable`) come
; first and specific ones (e.g. `@type`) come last.
; ============================================================================
