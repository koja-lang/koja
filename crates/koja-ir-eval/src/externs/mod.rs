...
pub(crate) async fn dispatch(
    ...
    match link_name {
        ...
        "koja_file_is_dir" => Some(fd::file_is_dir(args)),
        "koja_file_mkdir" => Some(fd::file_mkdir(args)),
        "koja_file_mkdir_p" => Some(fd::file_mkdir_p(args)),
        ...
        "koja_file_rmdir" => Some(fd::file_rmdir(args)),
        ...
        "koja_rt_mailbox_depth" => Some(runtime::mailbox_depth(args)),
        "koja_rt_process_count" => Some(runtime::process_count(args)),
        "koja_rt_process_count_by_state" => Some(runtime::process_count_by_state(args)),
        "koja_rt_process_state" => Some(runtime::process_state(args)),
        "koja_rt_sched_violations" => Some(runtime::sched_violations(args)),
        "koja_rt_scheduler_count" => Some(runtime::scheduler_count(args)),
        "koja_rt_self_mailbox_depth" => Some(runtime::self_mailbox_depth(args)),
        ...
        "koja_toolchain_version" => Some(system::toolchain_version(args)),
