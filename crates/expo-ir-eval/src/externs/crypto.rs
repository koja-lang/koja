//! Externs declared in `lib/crypto/src/{sha1,sha256,sha384,sha512,hmac}.expo`.
//!
...
//!
//! Argument shapes mirror the Expo declarations one-for-one (every
//! Expo-side `Int64` arrives here as `i64`; every Expo-side
...
//! `key_len`) we declare the extern with the wider Expo-shaped type
