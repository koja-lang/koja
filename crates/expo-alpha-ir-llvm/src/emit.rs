//! Native object-file emission via inkwell's `TargetMachine`. Mirrors
//! the v1 codegen pattern in `expo-codegen`'s `emit_object_file`,
//! trimmed to non-release defaults.
