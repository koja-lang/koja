...
use expo_ast::ast::{Item, Param, PassMode, TypeExpr, Visibility};
...
fn first_function(source: &str) -> expo_ast::ast::Function {
...
fn nth_function(source: &str, idx: usize) -> expo_ast::ast::Function {
    let file = parse_clean(source);
