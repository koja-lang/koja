...
impl Parser {
    ...
    pub(crate) fn parse_import_item(&mut self) -> Item {
                ...
                TokenKind::LBrace => {
                    ...
                    loop {
                        match self.peek().clone() {
                            ...
                            _ => {
                                // Keywords used as import names (e.g. spawn, signal)
        ...
        // Multi-segment paths: the last segment is the imported item
