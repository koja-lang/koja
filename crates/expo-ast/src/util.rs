//! Small string utilities shared across the Expo toolchain.
//!
...
//!   single caller).
//!
//! The bar is deliberately high — `expo_ast` is a leaf crate in the
...
/// Expo source (that's [`parser::dedent_multiline_parts`]); this is
