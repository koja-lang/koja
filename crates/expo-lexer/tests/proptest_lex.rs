...
//!
//! - `corpus_lexes_clean`: every `.expo` file under `lib/` and `tests/lang/`
...
use expo_lexer::{Span, TokenKind, lex};
...
/// `expo-ast/src/span.rs`) but the lexer's `Cursor` stores it as a character
