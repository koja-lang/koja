//! End-to-end smoke test for the v2 IR lowering pipeline at its POC scope.
//!
...
//! produce `Int(4)`.
//!
//! When this test passes, the v2 pipeline (typecheck + IR) is
//! end-to-end ready for `expo-ir-eval` rewiring.
