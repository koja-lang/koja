...
> Archived on 2026-07-22 after TLS shipped. This document preserves the
> implementation plan and its pre-implementation API sketches. See
> [LANGUAGE.md](../../LANGUAGE.md) and the generated `Net` and `HTTP` package
