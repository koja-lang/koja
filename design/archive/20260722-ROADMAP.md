...
> Archived on 2026-07-22. This snapshot preserves the phase-based roadmap
> and its original completion criteria. See the current
> [roadmap](../ROADMAP.md) for active commitments.
...
- **Conformance headers** -- agreed design in [20260809-CONFORMANCE-HEADERS.md](20260809-CONFORMANCE-HEADERS.md) (`struct Server<T>: Process<...>, Debug` declares conformance on the type, protocol methods live in the body, comma-separated list with `&` reserved for composition in type positions)
