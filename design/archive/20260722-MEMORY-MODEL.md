...
> Archived on 2026-07-22. This snapshot mixes the shipped RC and deep-copy
> model with uncommitted arenas, shared values, and rollout history. See the
> current [memory model](../MEMORY-MODEL.md) for the implemented contract.
